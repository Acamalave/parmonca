...
export const storeProducts: StoreProduct[] = [
  {
    ...
    badge: 'Mas Vendido',
    specs: {
      capacidadCarga: '2,500 kg',
      anchoPasillo: '2,135 mm',
      longitudSinHorquillas: '3,416 mm',
      anchoTotal: '1,252 mm',
      alturaChasis: '2,180 mm',
      tipoMotor: 'Electrico AC',
      bateria: '48V / 600Ah',
      mastil: 'Triple / Altura max. 4,500 mm',
    },
    descripcion: 'Montacarga electrico de alto rendimiento ideal para operaciones en interiores. Cero emisiones, bajo nivel de ruido y maxima eficiencia energetica.',
    caracteristicas: [
      'Motor AC de alta eficiencia',
      'Sistema de frenado regenerativo',
      'Pantalla multifuncion LCD',
      'Direccion asistida electrica',
      'Cabina ergonomica con suspension',
      'Autonomia de hasta 8 horas continuas',
    ],
  },
  {
    id: '2',
