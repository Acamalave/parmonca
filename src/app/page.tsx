...
export default function Home() {
  ...
  const whatsappMsg = encodeURIComponent(
    "Hola PARMONCA, me interesa información sobre sus montacargas y repuestos."
  );
  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="relative inline-flex items-center gap-2.5 rounded-full bg-[#25D366] px-7 py-3.5 text-[15px] font-semibold text-white shadow-lg shadow-[#25D366]/25 transition-transform hover:scale-[1.03]"
      >
